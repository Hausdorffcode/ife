...
function addAqiData() {
	...
	var inputAir = document.getElementById("aqi-value-input");
	var city = inputCity.value.trim();
	var air = inputAir.value.trim();
...
function renderAqiList() {
	...
	for(var city in aqiData){
		str += "<tr><td>"+city+"</td><td>"+aqiData[city]+"</td><td><button class='del-btn'>删除</button></td></tr>"
	}
